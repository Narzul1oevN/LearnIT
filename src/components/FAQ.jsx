...
const FAQSection = () => {
  const faqData = [
    ...
    { 
        ...
        answer: "Сейчас очень много где обещают горы за короткий курс, но реальные программисты знают, что достичь первых результатов за короткий срок очень сложно. В любом случае, после окончания курсов вы получите сертификат уровня джун или, как минимум, интерна." 
    },
    { 
